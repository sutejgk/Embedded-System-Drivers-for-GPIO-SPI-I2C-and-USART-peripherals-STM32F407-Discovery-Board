...
/*
 * I2C related status flags definitions(masking info of the fields in the SR register)
 */
...
void I2C_IRQInterruptConfig(uint8_t IRQNumber,uint8_t EnorDi);                   // Used to configure the IRQ number of the GPIO pin,like enabling it, setting up the priority etc
